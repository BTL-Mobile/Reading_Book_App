...
class _NotesScreenState extends State<NotesScreen> {
  ...
  List<Note> _filterNotes(List<Note> notes) {
    ...
    return notes
        .where(
          (n) => (n.bookId.isNotEmpty ? n.bookId : _prettyBookTitle(n)) == key,
        )
        .toList();
  }
      ...
      body: SafeArea(
        child: StreamBuilder<List<Note>>(
          ...
          builder: (context, snapshot) {
            ...
            final flashcardsCount = allNotes.where((n) => n.isConverted).length;
                    ...
                    sliver: SliverList.separated(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return _NoteCard(
                          ...
                          onDelete: () async {
                            await _noteService.moveToTrash(n.id);
    ...
    return SizedBox(
      ...
      child: ListView.separated(
        ...
        itemBuilder: (context, i) {
          ...
          final label = i == 0 ? 'Tất cả (${chip.count})' : chip.title;
          ...
          return InkWell(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: selected ? const Color(0xFF1D63FF) : Colors.white,
                borderRadius: BorderRadius.circular(999),
                border: Border.all(
                  color: selected
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: Colors.white,
          borderRadius: BorderRadius.circular(16),
          border: Border.all(color: const Color(0xFFF5B700), width: 1.2),
        ),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
