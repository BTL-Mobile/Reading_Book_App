                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 16), // Đã thêm const (Lỗi dòng 53)
                      const Text(
                        'Tạo lúc: lúc 07:00 Thứ Bảy, 16 tháng 11, 2024',
                        style: TextStyle(fontSize: 12, color: Color(0xFF9CA3AF)),
                      ),
                      const SizedBox(height: 24), // Đã thêm const (Lỗi dòng 76)
                      ...
                      Container(
                        ...
                        child: const Column( // Đã thêm const (Lỗi dòng 77, 78)
                          children: [
                            Row(
                              children: [
                            ...
                            SizedBox(height: 4),
                            Text(
                              'Ghi chú này đang được đưa vào lịch ôn tập',
                  ...
                  _buildActionButton(
                    ...
                    onTap: () => showDialog(
                      ...
                      builder: (context) => const CreateFlashcardDialog(
                        noteContent: 'Thói quen tốt là nền tảng cho sự thành công...',
